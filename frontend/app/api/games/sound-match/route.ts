...
// Starts a Sound Match session: reads the child's current difficulty for
// `phonological_awareness` (inter-session adaptivity), generates the
// server-authored 15-question plan (+ 2 warm-ups), and persists it to
// game_sessions.config so every trial can be graded against it later.
// See docs/saket/TRD.md "Anti-tamper model".
