...
export default function WordBuilderLayout({ children }: { children: React.ReactNode }) {
  return (
            ...
            <div className="flex flex-row items-center justify-between w-full px-[20px] pt-[10px] border-b-[2px] border-[#efefef] pb-[10px]">
                <div className="flex flex-row items-center justify-left">
                    <Image
                        ...
                        loading="eager"
                    />
                    <span className="font-pixel text-[20px] ml-2 text-[#1d1d1d]">opacity / word builder </span>
                </div>
