...
// Per-game copy of the same inline profile-creation form used by Rapid Match
// and Letter Detective. It is identical across games — flagged in
// app/sound-match/AGENTS.md as a candidate for promotion to components/ once
// whoever owns cross-game refactors decides (backend.md: "move to shared only
// when multiple routes genuinely need it").
